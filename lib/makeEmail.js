 ...
 * @returns
 */
async function makeTransportOptions(pOptions = {}) {
	...
	log('Not all SMTP properties set, using nodemailer test account')
 ...
 */
export default async function makeEmail(pOptions, pDefaults) {
	const transportOptions = await makeTransportOptions(pOptions)
